...
const char* OICServer = "https://nbldlovnexabulmc7zre7dyccq.apigateway.us-phoenix-1.oci.customer-oci.com/webhooks/iotreceiver";
const int sensorMin = 0;     //  sensor minimum
const int sensorMax = 1024;  // sensor maximum
const char* ssid = "Airtel_8454899945";
const char* password = "air47214";
//const char fingerprint[] PROGMEM = "47 FB 7C 49 E4 E4 16 2B 1C 33 9A 00 E2 79 51 48 52 6B 02 5B";
  ...
  case 0:    // A fire closer than 1.5 feet away.
    ...
    Serial.println("** Close  Fire **");
     if(WiFi.status()== WL_CONNECTED){
      HTTPClient https;
      https.begin(*client, OICServer);
      https.addHeader("Content-Type", "application/json");
      https.addHeader("Content-Length" ,"52098");
      char out[200];
